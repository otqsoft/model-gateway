...
CREATE TABLE IF NOT EXISTS `model_mapping` (
  ...
  `input_price`       DECIMAL(12,6)NOT NULL DEFAULT 0.000000 COMMENT '输入单价（元/百万 tokens）',
  `output_price`      DECIMAL(12,6)NOT NULL DEFAULT 0.000000 COMMENT '输出单价（元/百万 tokens）',
