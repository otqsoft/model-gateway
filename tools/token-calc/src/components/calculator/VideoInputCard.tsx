...
export function VideoInputCard({ items, onChange, totalTokens }: VideoInputCardProps) {
    ...
    try {
      ...
      for (const file of Array.from(files)) {
        ...
        try {
          ...
          const { total } = estimateVideoTokens(
            meta.durationSec,
            meta.width,
            meta.height
          );
        ...
        {items.length > 0 && (
          <div className="space-y-2 max-h-[280px] overflow-y-auto pr-1">
            {items.map((item) => (
              ...
              >
                <div className="w-8 h-8 rounded bg-amber/10 border border-amber/30 flex items-center justify-center shrink-0">
                ...
                <div className="text-right shrink-0">
                  <div className="font-mono text-amber font-semibold text-sm">
